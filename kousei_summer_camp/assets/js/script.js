...
function openModal(card){
  for(const [id,key] of [['modalName','name'],['modalJName','jname'],['modalGrade','grade'],['modalAge','age'],['modalGender','gender'],['modalKeyword','keyword'],['modalQuote','quote']]) document.getElementById(id).textContent=card.dataset[key]||'';
