...
function openModal(card){
  for(const [id,key] of [['modalName','jname'],['modalJName','name'],['modalGrade','grade'],['modalAge','age'],['modalGender','gender'],['modalKeyword','keyword'],['modalQuote','quote']]) document.getElementById(id).textContent=card.dataset[key]||'';
